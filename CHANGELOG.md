...
## 3.0.1
- fixed extension not deployable due to incompatible pipeline names

## 3.0.0
- moved the package to the @shopgate organization at NPM and renamed to @shopgate/shopware6-user
